                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bao_hanh" value="Bảo hành 365 ngày" required="">
                        </div>

                        <div class="form-group">
                            <label>Đi kèm</label>
                            <input type="text" class="form-control" name="phu_kien" value="Miễn phí khám sức khỏe tháng đầu tiên" required="">
                        </div>
                        <div class="form-group">
                            <label>Tình trạng</label>
                            <input type="text" class="form-control" name="tinh_trang" value="Sức khỏe 100%" required="">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="khuyen_mai" value="Bảo hiểm sức khỏe lên tới 1,000,000đ" required="">
                        </div>
                        <div class="form-group">
